            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav me-auto">
                    <li class="nav-item @if(request()->is('admin/halls')) active @endif">
                        <a class="nav-link @if(request()->is('admin/halls')) text-primary @endif" href="{{url('admin/halls') }}">{{ __('Sale') }}</a>
                    </li>
                    <li class="nav-item @if(request()->is('admin/movies')) active @endif">
                        <a class="nav-link @if(request()->is('admin/movies')) text-primary @endif" href="{{url('admin/movies') }}">{{ __('Movie') }}</a>
                    </li>
                </ul>
